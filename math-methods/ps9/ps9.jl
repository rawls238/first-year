...
long_run_return_b = run_analysis_for_four(st_b, 4, 100000);
long_run_low_return_b = long_run_return_b[3];
long_run_low_liquidity_b = long_run_return_b[4];
...
long_run_return_c = run_analysis_for_four(st_c, 4, 100000);
long_run_low_return_c = long_run_return_c[3];
long_run_low_liquidity_c = long_run_return_c[4];
