...
syms yT yTp rstar rstarp epsi epsip rer rerp
...
controls_in_logs = [cT h la w pNtilde yN paiN pvmc pvmr epsi pai output rer];
controls_in_logsp = [cTp hp lap wp pNtildep yNp paiNp pvmcp pvmrp epsip paip outputp rerp];
