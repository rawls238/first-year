...
statevar = [d states_in_logs rstar eta];
statevarp = [dp  states_in_logsp rstarp etap];
...
ETASHOCK = sym(zeros(ns,3)); 
ETASHOCK(ns-2:end,:) =[eta11 eta12 eta13;eta21 eta22 eta23;eta31 eta32 eta33];
