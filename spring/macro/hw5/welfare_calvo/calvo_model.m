...
%conditions of the model with staggered price setting a la Calvo  in the nontraded sector   developed in the chapter entitled  ``Nominal Rigidity, Exchange Rates,  And Unemployment''
...
syms v vp cT cTp r rp rstar rstarp   p pp h hp la lap w wp pNtilde pNtildep  yN yNp s sp d dp  dy dyp paiN paiNp pvmc pvmcp pvmr pvmrp output outputp tby tbyp  c cp pai paip a2 a2p

syms v_cons v_consp v_h v_hp
...
%Create function f
f = eval([ e1; e2; e3; e4; e5;e6;e7;e8;e9;e10;e11;e12;e13;e14;e15;e16;e17;e18;e19;e20;e21]);
...
controlvar = [controls_in_logs v v_cons v_h tby  r dy]; 
controlvarp = [controls_in_logsp vp v_consp v_hp tbyp rp  dyp]; 
...
%Compute analytical derivatives of f
 [fx,fxp,fy,fyp,fypyp,fypy,fypxp,fypx,fyyp,fyy,fyxp,fyx,fxpyp,fxpy,fxpxp,fxpx,fxyp,fxy,fxxp,fxx] = anal_deriv(f,statevar,controlvar,statevarp,controlvarp,approx);

%Make f and its derivatives a function of the level of its arguments rather than the log

x=  {'f','fx','fxp','fy','fyp','fypyp','fypy','fypxp','fypx','fyyp','fyy','fyxp','fyx','fxpyp','fxpy','fxpxp','fxpx','fxyp','fxy','fxxp','fxx'};

nnx = numel(x); 

for j=1:nnx
eval([
x{j} ' = subs(' x{j} ', variables_in_logs, log(variables_in_logs));'])
end
